...
locals {
  azure_resource_group_name_logs = var.logs_destination_azure_resource_group_name != "" ? var.logs_destination_azure_resource_group_name : module.context.resource_group.name
